...
class ProductsRepository {
  static const _allProducts = <model.Product>[
    model.Product(
      category: model.Category.accessories,
      id: 0,
      isFeatured: true,
      name: 'Vagabond sack',
      price: 120,
    ...
    model.Product(
      category: model.Category.clothing,
      id: 19,
      isFeatured: false,
      name: 'Clay sweater',
      price: 48,
  ...
  static List<model.Product> loadProducts(model.Category category) {
    if (category == model.Category.all) {
      return _allProducts;
    }
